...
to_remove=(xdg-desktop-portal-wlr hyprlock bun-bin greetd-dms-greeter-git thunar gvfs gvfs-afc gvfs-mtp gvfs-smb clipse-bin greetd-tuigreet xdg-desktop-portal-kde)
